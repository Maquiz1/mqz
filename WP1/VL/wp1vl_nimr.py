...
merged = merged.sort_values(by='enrollment_id')

print("\nMerged data (first 5 rows):")
print(merged.head())

# Optionally save the merged result
merged.to_excel('~/Documents/KEMR/REPORTS/WP1/NIMR/_2025_06_19_WP1_VL_DATA/WP1_VL_NIMR_DATA_2025_06_19.xlsx', index=False)
